...
import {Arrays} from "./lib/utils/Arrays.sol";
import {IERC1155} from "@openzeppelin/contracts/interfaces/IERC1155.sol";
import {IERC1155Errors} from "./interfaces/draft-IERC6093.sol";
import {IERC1155Receiver} from "@openzeppelin/contracts/token/ERC1155/utils/IERC1155Receiver.sol";
...
/**
  ...
  //  function erc1155Approve(address spender_, uint256 id_)
    ...
    function _safeTransferFrom(address from, address to, uint256 id, uint256 value, bytes memory data) internal {
        ...
        uint256 amount = _sumProduct(ids, values);
    ...
    function setApprovalForAll(
        ...
        emit ERC115Events.ApprovalForAll(msg.sender, operator_, approved_);
    }
    ...
    function _transferERC1155(address from_, address to_, uint256 amount_) internal {
        ...
        uint256[] memory tokens = calculateTokens(amount_);
        _update(from_, to_, tokenValues, tokens);
    }
