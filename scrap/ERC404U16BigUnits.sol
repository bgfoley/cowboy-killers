...
abstract contract ERC404U16BigUnits is IERC404 {
    ...
    /// @dev Units for ERC-20 representation of ERC721s
    uint256 public immutable BigUnits;

    /// @dev Units for ERC-20 representation of ERC1155s - For use with ERC404U16WithERC1155Extension
    uint256 public immutable subUnits;
