...
contract Cowboy is Ownable, ERC404 {
    ...
    function getERC721QueueLength(uint256 value) public view override
     returns (uint256) {
        DoubleEndedQueue.Uint256Deque storage deque = _storedERC721sByValue[value];
        return deque.length();
    }
...
/*
    function _getOwnerOf(
        uint256 id_
      ) internal view override returns (address ownerOf_) {
