...
/*
/// updated to new mapping
    function getERC721QueueLength(
        uint256 tokenValue_
      ) public view override returns (uint256) {
        uint256[] memory queue = _storedERC721sByValue[tokenValue_];
      {
        return queue.length();
        }
      }
...
/// DONE - override to add tokenValue
...
///modify for tokenValues
    ...
    function calculateTokens(uint256 _units) internal viewnpx h returns (uint256[] memory) {
